  ...
  return <footer className="border-t border-black/10 py-16 md:py-24">
    <div className="container">
      <div className="grid gap-16 md:grid-cols-[1.4fr_1fr]">
        <div data-reveal><p className="eyebrow">استودیو معماری</p><h2 className="mt-5 max-w-3xl text-[clamp(3rem,7vw,7rem)] font-light leading-[.95] tracking-[-.055em]">فضاهایی برای<br/>زندگی و سکوت.</h2></div>
        <div className="flex flex-col justify-between gap-12 md:items-end" data-reveal>
      ...
      <div className="mt-20 flex justify-between border-t border-black/10 pt-5 text-[.7rem] text-neutral-500" data-reveal><span>© ۱۴۰۵ استودیو معماری</span><span>ارومیه، ایران</span></div>
    </div>
  </footer>;
}
